...
const WhyChooseUs = () => {
  return (
    <section className="relative w-full min-h-screen bg-gradient-to-br from-blue-50 to-white flex flex-col items-center justify-center px-6 py-24 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-between max-w-screen-2xl w-full px-6 md:px-12">
        <div className="space-y-6 md:max-w-xl text-center md:text-left">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground max-w-md md:max-w-lg mx-auto md:mx-0">
        ...
        <img src="/man.png" alt="Guy holding phone" className="mt-10 md:mt-0 w-72 md:w-[900px] h-auto object-contain drop-shadow-xl" />
      </div>
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-between max-w-screen-2xl w-full mt-20 px-6 md:px-12 space-y-12 md:space-y-0 md:space-x-16">
        <img src="/woman.png" alt="Girl using phone" className="w-72 md:w-[900px] h-auto object-contain drop-shadow-xl" />
